...
const technician_m_js_1 = __importDefault(require("../models/technician-m.js"));
exports.default = {
    ...
    technicianFindByID: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            //Objetos de negocio
            const serviceQueueExists = yield index_js_1.default.ServiceQueue.findAll({
                include: {
                    model: technician_m_js_1.default,
                    as: 'Technician',
            ...
            return res.json({
                ok: true,
                serviceQueueListed: serviceQueueExists
            });
        }
        catch (error) {
            console.log(error);
