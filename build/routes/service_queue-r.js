...
const service_queue_c_1 = __importDefault(require("../controllers/service_queue-c"));
const validate_field_h_js_1 = __importDefault(require("../helpers/validate_field-h.js"));
//Instanacia del routerx
const router = (0, express_promise_router_1.default)();
//Ruta Listar
router.get('/list', service_queue_c_1.default.serviceQueueList);
//Ruta Crear
router.post('/create', [
    //CustomerId
...
], service_queue_c_1.default.serviceQueueCreate);
//Ruta Crear
router.get('/find/:TechnicianId', [
    ...
    validate_field_h_js_1.default.validateField
], service_queue_c_1.default.technicianFindByID);
