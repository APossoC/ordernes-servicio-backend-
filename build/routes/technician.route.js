...
const technician_controller_1 = __importDefault(require("../controllers/technician.controller"));
const validate_field_helper_1 = __importDefault(require("../helpers/validate_field.helper"));
//Instanacia del routerx
const router = (0, express_promise_router_1.default)();
//Ruta Listar
router.get('/list', technician_controller_1.default.technicianList);
//Ruta Crear
router.post('/create', [
    //TechnicianName
    ...
    validate_field_helper_1.default.validateField
], technician_controller_1.default.technicianCreate);
